            ...
            if (!blockMesh.hasIndex) {
                node->UseMesh([&](auto& mesh) {
                    ...
                    mesh.uvTriangles.push_back({
                        Vector2f(0.000059f, 0.5f-0.000004f),
                        Vector2f(0.000103f, 0.5f-0.336048f),
                        Vector2f(0.335973f, 0.5f-0.335903f),
                    });
                    mesh.uvTriangles.push_back({
                        Vector2f(1.000023f, 0.5f-0.000013f),
                        Vector2f(0.667979f, 0.5f-0.335851f),
                        Vector2f(0.999958f, 0.5f-0.336064f),
                    });
                    mesh.uvTriangles.push_back({
                        Vector2f(0.667979f, 0.5f-0.335851f),
                        Vector2f(0.336024f, 0.5f-0.671877f),
                        Vector2f(0.667969f, 0.5f-0.671889f),
                    });
                    mesh.uvTriangles.push_back({
                        Vector2f(1.000023f, 0.5f-0.000013f),
                        Vector2f(0.668104f, 0.5f-0.000013f),
                        Vector2f(0.667979f, 0.5f-0.335851f),
                    });
                    mesh.uvTriangles.push_back({
                        Vector2f(0.000059f, 0.5f-0.000004f),
                        Vector2f(0.335973f, 0.5f-0.335903f),
                        Vector2f(0.336098f, 0.5f-0.000071f),
                    });
                    mesh.uvTriangles.push_back({
                        Vector2f(0.667979f, 0.5f-0.335851f),
                        Vector2f(0.335973f, 0.5f-0.335903f),
                    ...
                    mesh.uvTriangles.push_back({
                        Vector2f(1.000004f, 0.5f-0.671847f),
                        Vector2f(0.999958f, 0.5f-0.336064f),
                        Vector2f(0.667979f, 0.5f-0.335851f),
                    });
                    mesh.uvTriangles.push_back({
                    ...
                    mesh.uvTriangles.push_back({
                        Vector2f(0.000103f, 0.5f-0.336048f),
                        Vector2f(0.000004f, 0.5f-0.671870f),
                        Vector2f(0.336024f, 0.5f-0.671877f),
                    });
                    mesh.uvTriangles.push_back({
                        Vector2f(0.000103f, 0.5f-0.336048f),
